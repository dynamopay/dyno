...
* dyno.conf: contains configuration settings for dynod or dyno-qt
* dynod.pid: stores the process id of dynod while running
...
* debug.log: contains debug information and general logging generated by dynod or dyno-qt
