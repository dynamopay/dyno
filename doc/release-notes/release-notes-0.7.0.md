Bitcoin version 0.7.0 is now available for download at:
  http://sourceforge.net/projects/dyno/files/Bitcoin/dyno-0.7.0/

We recommend that everybody running prior versions of dynod/Bitcoin-Qt
...
source-only tarballs/zipballs directly from there:
  https://github.com/dynamopay/dyno/tarball/v0.7.0  # .tar.gz
  https://github.com/dynamopay/dyno/zipball/v0.7.0  # .zip
...
Core dyno handling and blockchain database
...
* Ensure a changed dyno unit immediately updates all GUI elements that use units
...
* (Windows only): enable ASLR and DEP for dyno-qt.exe
* (Windows only): add meta-data to dyno-qt.exe (e.g. description)
...
* Bash programmable completion for dynod(1)
