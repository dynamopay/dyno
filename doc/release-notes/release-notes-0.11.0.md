Bitcoin Core version 0.11.0 is now available from:
  ...
  <https://dyno.org/bin/dyno-core-0.11.0/>
...
For example, add the following to `dyno.conf`:
...
related to the blockchain in the dyno system: the raw blocks as received over 
...
For an example script see [dyno-submittx](https://github.com/laanwj/dyno-submittx).
...
- #5334 `cf87536` libdynoconsensus: Add pkg-config support
...
- #6269 `95aca44` gitian: Use the new dyno-detached-sigs git repo for OSX signatures
...
- #5753 `0f44672` Add dyno logo to about screen
...
- #5809 `46bfbe7` Add dyno-cli man page
...
- #5849 `41259ca` contrib/init/dynod.openrc: Compatibility with previous OpenRC init script variables
...
- #6098 `7708fcd` Update Windows resource files (and add one for dyno-tx)
