Bitcoin Core version 0.11.1 is now available from:
  ...
  <https://dyno.org/bin/dyno-core-0.11.1/>
...
(see https://github.com/dynamopay/dyno/pull/6795).
...
one was randomly violated by all deployed dyno software prior to
...
http://fc15.ifca.ai/preproceedings/dyno/paper_9.pdf
...
(see https://github.com/dynamopay/dyno/pull/6793, as well as the 0.11
...
- #6571 `100ac4e` libdynoconsensus: avoid a crash in multi-threaded environments
