/* src/config/dyno-config.h.  Generated from dyno-config.h.in by configure.  */
/* src/config/dyno-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef DYNO_CONFIG_H

#define DYNO_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/dynamopay/dyno/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Dyno Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Dyno Core 0.12.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dynocore"
