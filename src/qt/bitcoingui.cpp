    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Dyno Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dyno address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dyno: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Dyno Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dyno Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dyno Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dyno addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dyno addresses"));
    ...
    openAction->setStatusTip(tr("Open a dyno: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dyno Core help message to get a list with possible Dyno Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dyno Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Dyno network", "", count));
}
...
{
    QString strTitle = tr("Dyno Core"); // default title
