    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("DYO-light"), QVariant("light"));
    ui->theme->addItem(QString("DYO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("DYO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("DYO-traditional"), QVariant("trad"));
