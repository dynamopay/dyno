    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Dyno Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Dyno Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  dyno-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Dyno in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DYO, 0.1 DYO, 1 DYO and 10 DYO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://dynocoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://dynocoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Dyno Core is shutting down...") + "<br /><br />" +
