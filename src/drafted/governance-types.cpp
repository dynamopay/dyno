...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DynoNetwork") type = DynoNetwork;
    if(strType == "DynoNetworkVariable") type = DynoNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DynoNetwork) s = "DynoNetwork";
    if(type == DynoNetworkVariable) s = "DynoNetworkVariable";
