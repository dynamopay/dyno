 ...
 *
 *   // network
 *   CDynoNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.dynamopay.io/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDynoNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: DynoNetwork
// //   -- signature requirements : Key1(User)
// class CDynoNetworkVariable : public CGovernanceObject
// {
// private:
